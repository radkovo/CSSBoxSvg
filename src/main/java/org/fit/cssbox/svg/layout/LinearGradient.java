...
public class LinearGradient {
     ...
     * podle rozmeru elementu, pro ktery je gradient vykreslovan vypocte prislusne krajni body gradientu, podle kterych se pak generuje SVG kod 
     * vsechny vypoctene souradnice jsou v procentualnich hodnotach pro vysledny SVG element linearGradient
     * @param deg
     * @param w
     * @param h 
     */
